...
image=Image.open("C:/Users/ajayc/Downloads/humanresourceimage2.webp")
st.image(image)
...
data = pd.read_csv("C:/Users/ajayc/Guviprojects/final_HR.csv")
...
st.write(f":green[Total number of state workers]: {total_state_workers}")
total_district_workers = district_data['MainWorkersTotalPersons'].sum()
st.write(f":blue[Total number of district workers]: {total_district_workers}")

st.subheader(":red[Data Summary]")
